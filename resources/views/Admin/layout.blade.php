  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{asset('public/Admin/images/logo.svg')}}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('public/Admin/images/logo-mini.svg')}}" alt="logo"/></a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{Route('product')}}">All PRODUCT</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{Route('allBrand')}}">All BRAND</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{Route('allBill')}}">LIST BILL</a></li>
